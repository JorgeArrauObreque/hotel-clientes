...
public partial class HotelClientesContext : DbContext
{
    public HotelClientesContext()
    {
    }

    public HotelClientesContext(DbContextOptions<HotelClientesContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cliente>(entity =>
        {
            ...
            entity.HasOne(d => d.IdEstadoNavigation).WithMany(p => p.Clientes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_clientes_cliente_estado");
